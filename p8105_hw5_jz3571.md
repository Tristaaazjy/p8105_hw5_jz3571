...
### Make a plot showing the average estimate of μ̂ on the y axis and the true value of μ on the x axis. Overlay a second plot of the average estimate of μ̂ only in samples for which the null was rejected on the y axis and the true value of μ on the x axis.
...
The two plots are approximately the same starting from = 3. At = 1, the
average only in samples for which the null was rejected is around 2,
instead of 1.
