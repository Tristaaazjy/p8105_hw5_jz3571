...
| Tulsa_AL          | 0.0000000 | 0.0000000 | 0.9453792 |
...
The two plots are approximately the same starting from $\mu$ = 3. At
$\mu$ = 1, the average $\hat \mu$ only in samples for which the null was
rejected is around 2, instead of 1.
